...
class TimeoutCog(Cog):
    ...
    @option(LC_COG_COMMAND_OPTION_MICROSECONDS_NAME, float, description=LC_COG_COMMAND_OPTION_MICROSECONDS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_MILLISECONDS_NAME, float, description=LC_COG_COMMAND_OPTION_MILLISECONDS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_SECONDS_NAME, float, description=LC_COG_COMMAND_OPTION_SECONDS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_MINUTES_NAME, float, description=LC_COG_COMMAND_OPTION_MINUTES_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_HOURS_NAME, float, description=LC_COG_COMMAND_OPTION_DAYS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_DAYS_NAME, float, description=LC_COG_COMMAND_OPTION_DAYS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_WEEKS_NAME, float, description=LC_COG_COMMAND_OPTION_WEEKS_DESCRIPTION, required=False, min_value=1, default=0)
    @option(LC_COG_COMMAND_OPTION_REASON_NAME, str, description=LC_COG_COMMAND_OPTION_REASON_DESCRIPTION, default=LC_COG_COMMAND_OPTION_REASON_DEFAULT)
    async def callback(
        self,
